...
VoTT_Folder = os.path.join(Image_Folder, "files_to_train")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=11,
        help="Number of epochs for training last layers and number of epochs for fine-tuning layers. Default is 11.",
    )
    parser.add_argument(
        "--warnings",
        default=False,
    ...
    if _has_wandb:
        wandb.init(
            project="YOLOv3", config=vars(FLAGS), sync_tensorboard=False
        )
